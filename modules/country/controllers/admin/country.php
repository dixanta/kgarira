...
{
	protected $uploadPath = 'uploads/country';
protected $uploadthumbpath= 'uploads/country/thumb/';
...
($params['search']['country_code']!='')?$this->db->where('country_code',$params['search']['country_code']):'';
...
$data['flag_image'] = $this->input->post('flag_image');
