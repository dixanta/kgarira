...
<tr><td><label><?php echo lang('guest_name')?></label>:</td>
<td><input type="text" name="search[guest_name]" id="search_guest_name"  class="easyui-validatebox"/></td>
<td><label><?php echo lang('guest_email')?></label>:</td>
<td><input type="text" name="search[guest_email]" id="search_guest_email"  class="easyui-validatebox"/></td>
</tr>
<tr>
...
<th data-options="field:'guest_name',sortable:true" width="50"><?php echo lang('guest_name')?></th>
<th data-options="field:'guest_email',sortable:true" width="50"><?php echo lang('guest_email')?></th>
...
<div id="dlg" class="easyui-dialog" style="width:600px;height:auto;padding:10px 20px"
    ...
    <table>
		<tr>
		              <td width="34%" ><label><?php echo lang('guest_name')?>:</label></td>
					  <td width="66%"><input name="guest_name" id="guest_name" class="easyui-validatebox" required="true"></td>
		       </tr><tr>
		              <td width="34%" ><label><?php echo lang('guest_email')?>:</label></td>
					  <td width="66%"><input name="guest_email" id="guest_email" class="easyui-validatebox" required="true"></td>
		       </tr><tr>
